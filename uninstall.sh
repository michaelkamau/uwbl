...
rm -f "$PREFIX/bin/uwbld" "$PREFIX/bin/omarchy-eluktonics-keyboard" \
...
depmod -a
echo "omarchy-eluktonics-keyboard removed. The in-tree uniwill-laptop module is active again after reboot."
